...
def open_file_dialog():
    ...
    space_objects = inp.read_space_objects_data_from_file(in_filename)
...
def save_file_dialog():
    ...
    Считанные объекты сохраняются в глобальный список space_objects
    """
    out_filename = fd.asksaveasfilename(filetypes=(("Text file", ".txt"),))
    inp.write_space_objects_data_to_file(out_filename, space_objects)
